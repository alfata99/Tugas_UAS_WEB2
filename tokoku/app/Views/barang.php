            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="netto" name="netto" placeholder="Berat. (contoh 20 ml)">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="hargaKulak" name="hargaKulak" placeholder="Harga Beli" value="0">
                        </div>
                    </div>
                </form>
            </div>
