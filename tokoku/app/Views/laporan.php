...
<script>
    ...
    function tampilkan() {
        ...
        if (tanggalMulai > tanggalSelesai) {
            ...
            var tabel = '<table id="add-row" class="display table table-striped table-hover" ><thead><tr><th>NO</th><th>ID</th><th>TANGGAL</th><th>NAMA</th><th>BERAT</th><th>HARGA BELI</th><th>HARGA JUAL</th><th>JUMLAH</th><th>TOTAL</th><th>UNTUNG</th><th>KASIR</th></tr></thead><tbody>'
            $.ajax({
