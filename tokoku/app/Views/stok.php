            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Contoh : baru beli, salah input, rusak, dll">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function ambilData() {
        ...
        var tabel = '<table id="tabelStok" class="display table table-striped table-hover" ><thead><tr><th>TANGGAL</th><th>ID BARANG</th><th>NAMA</th><th>BERAT</th><th>PENYESUAIAN</th><th>KETERANGAN</th><th>USER</th></tr></thead><tbody>'
        var baris = ''
        $.ajax({
